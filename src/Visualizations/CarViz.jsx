            ...
            <div> 
                <svg ref={node => this.node = node} width={this.props.size[0]} height={this.props.size[1]} className='single-bar'>
                    <g  transform={translateLF}>
                        <rect className="outerBar" x={borderLF.x + borderLF.width/4} y={borderLF.y}  width={borderLF.width/2} height={borderLF.height} />
                        <rect className="innerBar"  x={valueLF.x}  y={valueLF.y} width={valueLF.width} height={valueLF.height} />
                    </g>
                    <g  transform={translateRF}>
                        <rect className="outerBar" x={borderRF.x + borderRF.width/4} y={borderRF.y}  width={borderRF.width/2} height={borderRF.height} />
                        <rect className="innerBar"  x={valueRF.x}  y={valueRF.y} width={valueRF.width} height={valueRF.height} />
                    </g>                    
                    <g  transform={translateLB}>
                        <rect className="outerBar" x={borderLB.x + borderLB.width/4} y={borderLB.y}  width={borderLB.width/2} height={borderLB.height} />
                        <rect className="innerBar"  x={valueLB.x}  y={valueLB.y} width={valueLB.width} height={valueLB.height} />
                    </g>
                    <g  transform={translateRB}>
                        <rect className="outerBar" x={borderRB.x + borderRB.width/4} y={borderRB.y}  width={borderRB.width/2} height={borderRB.height} />
                    ...
                    <g className="car" transform={translateCar}>
                        <defs>
                            ...
                            <linearGradient x1="50%" y1="5.01434949%" x2="50%" y2="97.8435906%" id="linearGradient-3">
                                ...
                                <stop stop-color="#111C24" offset="21.8371333%"></stop>
                                <stop stop-color="#111C24" offset="79.5141103%"></stop>
                        ...
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g id="Car-Dark-II" transform="translate(2.000000, 1.000000)">
                                <polyline id="Path-3" stroke="#202A34" stroke-width="3" points="85.9677419 123.709677 56.6772792 113.248798 41.9354839 107.983871"></polyline>
                                <path d="M177.177419,122.66129 L219.112903,107.983871 L177.177419,122.66129 Z" id="Path-3" stroke="#202A34" stroke-width="3"></path>
                                <g id="Rectangle">
                                    <use fill="#111C24" fill-rule="evenodd" href="#path-1"></use>
                                    <rect stroke="#202A34" stroke-width="3" x="76.983871" y="90.6129032" width="110.225806" height="38.9354839"></rect>
                                </g>
                                <path d="M43.5080645,89.6734991 L43.5080645,123.169103" id="Path-3" stroke="#2D3B48" stroke-width="5"></path>
                                <path d="M217.540323,89.6740471 L217.540323,122.120187" id="Path-3" stroke="#2D3B48" stroke-width="5"></path>
                                <polyline id="Path-7" stroke="#A3A8A9" stroke-width="4" points="30.4032258 98.5483871 133.07361 65 232.741935 98.5483871"></polyline>
                                <polygon id="Path-2" stroke="#A3A8A9" stroke-width="4" points="34.5967742 105.503541 83.5691102 90.1612903 182.111006 90.1612903 227.5 105.503541 227.5 117.777341 180.064781 131.048387 174.347099 140.483871 94.9163587 140.483871 82.3746629 133.119591 34.5967742 117.777341"></polygon>
                                <path d="M23.0645161,412.016129 L232.741935,412.016129" id="Path-5" stroke="#202A34" stroke-width="6"></path>
                                <polygon id="Path-4" stroke="#A3A8A9" stroke-width="4" points="32.5 405.634642 65.6989247 391.048387 199.158602 391.048387 231.693548 405.634642 231.693548 412.327973 231.693548 420.220898 199.158602 432.983871 65.6989247 432.983871 32.5 420.220898 32.5 412.320009"></polygon>
                                ...
                                <polygon id="Path-6" stroke="#42515A" stroke-width="2" fill="#111C24" points="105.392297 0 88.5348206 89.9907252 88.5348206 136.8873 75.483871 299.124101 78.2028188 451.854839 185.329364 451.854839 191.854839 299.124101 176.628731 136.8873 176.628731 89.9907252 161.402623 0"></polygon>
                                <g id="Rectangle-6">
                                    <use fill-opacity="0.3" fill="#06121B" fill-rule="evenodd" href="#path-2"></use>
                                    <path stroke="#979797" stroke-width="1" d="M100.042886,139.935484 L83.3829782,285.709677 L184.992075,285.709677 L165.208435,139.935484 L100.042886,139.935484 Z"></path>
                                </g>
                                <polyline id="Path" stroke="#A3A8A9" stroke-width="4" points="109.032258 139.435484 132.396313 154.112903 155.16129 139.435484"></polyline>
                                <polyline id="Path-12" stroke="#A3A8A9" stroke-width="2" opacity="0.408797554" points="121.612903 0 102.741935 90.654649 102.741935 136.290323"></polyline>
                                <polyline id="Path-12" stroke="#A3A8A9" stroke-width="2" opacity="0.408797554" transform="translate(152.016129, 67.620968) scale(-1, 1) translate(-152.016129, -67.620968) " points="161.451613 1.0483871 142.580645 89.6110057 142.580645 134.193548"></polyline>
                                <polyline id="Path-12" stroke="#A3A8A9" stroke-width="2" opacity="0.313179348" points="124.758065 310.322581 102.741935 392.069661 102.741935 450.806452"></polyline>
                                <polyline id="Path-12" stroke="#A3A8A9" stroke-width="2" opacity="0.313179348" transform="translate(152.540323, 380.564516) scale(-1, 1) translate(-152.540323, -380.564516) " points="163.548387 310.322581 141.532258 392.069661 141.532258 450.806452"></polyline>
                                <path d="M104.83871,18.8709677 L161.975806,18.8709677" id="Line" stroke="#2D3B48" stroke-width="5" stroke-linecap="square"></path>
                                <path d="M104.83871,15.7258065 L162.5,15.7258065" id="Line" stroke="#A3A8A9" stroke-linecap="square"></path>
                                <path d="M102.741935,20.4435484 L163.250222,20.4435484" id="Line" stroke="#A3A8A9" stroke-width="2" stroke-linecap="square"></path>
                                ...
                                <path d="M98.5483871,141.532258 L79.6774194,288.306452" id="Path-9" stroke="#42515A" stroke-width="2"></path>
